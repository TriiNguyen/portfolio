export const projects = [
  ...
  {
    title: 'Movie App',
    description: "Build a basic movie app with using Redux Toolkit, with fully responsive and allowing to search film information with OMDb API",
      image: '/images/movieapp.png',
      tags: ['Javascript','React', 'Axios','Redux-toolkit'],
    source: 'https://github.com/TriiNguyen/MovieApp',
    visit: 'https://movie-app-orpin-eta.vercel.app/',
    id: 2,
  },
];
